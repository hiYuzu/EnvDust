 ...
 * 
 * @author	任崇彬
 * @version	1.0, 2016年4月10日下午5:00:56
 * @since	EnvDust 1.0.0
 * 
 */
public class MonitorSet extends BasePojo{
	...
	private Timestamp startTime = DateUtil.GetSystemDateTime(0);//开始时间
	private Timestamp endTime = DateUtil.GetSystemDateTime(0);//结束时间
