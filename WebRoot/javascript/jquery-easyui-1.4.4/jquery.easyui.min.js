...
(function($) {
	...
	function _284(_285) {
		...
		_286.window.draggable({
			...
			onStopDrag : function(e) {
				//TOOD: 用于控制弹出框拖拽范围此处被改写；原_286.options.left = e.data.left;_286.options.top = e.data.top;
				var screenwidthMy = document.body.clientWidth;//网页可视宽度、高度；
				var screenheightMy = document.body.clientHeight;
				if(e.data.left<10){
					_286.options.left = 10;
				}
				else if(screenwidthMy>100 && e.data.left>(screenwidthMy-100)){
					_286.options.left = screenwidthMy-100;
				}
				else{
				...
				else if(screenheightMy>100 && e.data.top>(screenheightMy-100)){
					_286.options.top = screenheightMy-100;
				}
				else{
